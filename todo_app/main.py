...
@app.post('/todos/new',status_code=status.HTTP_201_CREATED)
def new_todo(db: db_dependency, todo_req: todoRequest):
...
@app.delete('/todo/del/{id}',status_code=status.HTTP_204_NO_CONTENT)
